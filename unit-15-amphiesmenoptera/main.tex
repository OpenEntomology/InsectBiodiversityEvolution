...
\textbf{Amphiesmenoptera} comprises two familiar orders, Lepidoptera (moths and butterflies) and Trichoptera (caddisflies), whose close relationship is uncontroversial. To open this unit we'll discuss the evolutionary significance of two characteristics shared by these insects: silk production (from the labium) and possession of setiferous wings.\\

\noindent{}\textbf{Lepidoptera} is one of the ``big four'' orders of insects, and with \textgreater157,000 described species and at least 350,000, probably many more, remaining to be described. These insects are commonly referred to as moths and butterflies, and they remain one of the most recognizable groups of insects. Family-level diagnostics can be difficult, however, given that many characters are obscured by scales. The vast majority of species feed on plants as larvae (caterpillars), and adults live on liquid diets, imbibed through siphon-like mouthparts.\\

\noindent{}\textbf{Trichoptera} comprises approximately 13,000 species,  %http://www.mapress.com/zootaxa/2007f/zt01668p698.pdf
the vast majority of which are aquatic as larvae. Larvae exhibit diverse life history strategies and serve as important indicators of environmental health. For these reasons, we'll be examining larval specimens alongside adults.
...
\section{Lepidoptera}
\begin{itemize}
\item wings covered in scales (flattened setae)
\item mouthparts usually modified into long coiled siphoning proboscis for obtaining nectar or other fluids
\item hind wings usually of a different shape (usually shorter and more rounded) than fore wings
\item maxillary palpi usually reduced, labial palpi conspicuous
\end{itemize}
...
\begin{itemize}
\item antennae simple, pectinate or bipectinate
\item no basal areole in hindwing; Sc and Rs in hind wing widely separated, not fused 
\item fore wing M2 arising closer to M1 than M3
\item frenulum absent
\item proboscis reduced or absent
\item medium-sized to large, with broad wings and short, thick bodies 
\item vestigial mouthparts
\end{itemize}
...
\subsubsection{Lasiocampidae (tent caterpillar moths)}
\begin{itemize}
\item antennae bipectinate
\item basal areole in hind wing present; Sc and Rs briefly fused
\item fore wing M2 arising closer to M3 than M1
\item frenulum absent
\item proboscis vestigial or absent
\item humeral area of hind wing greatly expanded, with veins
\item fore wing with Cu2 arising far proximally
\item small to medium-sized, fat-bodied, fairly hairy moths
\item mouthparts reduced
\end{itemize}
...
\begin{itemize}
\item antennae usually bipectinate, occasionally simple
\item tympana as in Arctiidae and Noctuidae but pointing downward
\item no basal areole in hindwing; Sc and Rs in hind wing parallel, not fused 
\item fore wing M2 arising in midway between M1 and M3 (key character to separate from Noctuidae and Erebidae)
\item fore wing usually conspicuously longer than hind wing
\item medium-sized, stout moths, usually drab-colored
\item may resemble Geometridae, but the patterns on the fore wings do not continue to the hind wings
\end{itemize}
...
\begin{itemize}
\item fore wing + hind wing with apparent 4 branches in cubital veins. Quadrifid forewings (CU2, CU1, M3, M2 appear to form branch of 4
\end{itemize}
...
\begin{figure}[ht!]
    ...
    \begin{subfigure}[ht!]{0.38\textwidth}
        ...
        \label{fig:erebid2}
    \end{subfigure}
    \caption{Noctuidae}\label{fig:erebids}
\end{figure}

\subsubsection{Noctuidae (owlet moths)}
\begin{itemize}
\item antennae usually simple, occasionally bipectinate, sometimes swollen apically
\item tympanum on metathorax pointing back or outwards tympanal hood behind spiracle
\item labial palps usually relatively long, upturned
\item ocelli sometimes present
\item medium-sized to large, usually cryptic fore wings, sometimes with sudden white spots
\end{itemize}
...
\section{Trichoptera}
\begin{itemize}
\item at least front wings very hairy
\item tarsi always with 5 tarsomeres
\item adults usually with highly reduced mouthparts (haustellum) but long palpi
\item aquatic larvae; many species make cases of pebbles, leaves, or twigs
\end{itemize}
...
\begin{itemize}
\item antennae short
\item mesoscutum without warts
\item fore tibiae with 1 spur
\item very small (usually less than 5 mm)
\item usually mottled grayish or brownish and very hairy
\end{itemize}
...
\begin{itemize}
\item antennae long, usually less than 2$\times$ body
\item ocelli absent
\item mesoscutum without warts
\item much larger than Hydroptilidae (medium-sized usually)
\end{itemize}
...
\begin{itemize}
\item antennae very long, hairlike, often 2$\times$ body length
\item ocelli absent
\item pronotum with a pair (or 2) of warts separated by notch
\item mesoscutum with 2 irregular rows of bristly spots
\item slender, small to medium-sized
\end{itemize}
...
\begin{itemize}
\item antennae usually about as long as body
\item ocelli present
\item fore tibiae with 2 or more spurs
\item middle tibiae with 4 spurs
\item male maxillary palps 4-segmented
\item usually among the largest caddisflies, often mottled and brown
\end{itemize}
...
\item antennae usually about as long as body
\item ocelli present
\item fore tibiae with 1 spur or none
\item middle tibiae with 2 or 3 spurs
\item male maxillary palps 3-segmented
\item also often large, usually more brown with dark markings
\end{itemize}

\begin{figure}[ht!]
  \centering
    \includegraphics[width=0.6\textwidth]{TrichoImage02}
  \caption{Limnephilidae}
  \label{fig:phryg}
\end{figure}
