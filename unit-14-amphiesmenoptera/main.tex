...
Andrew R. Deans and Istv\'an Mik\'o wrote the text. Chris Grinter (Illinois Natural History Survey) vetted earlier versions of this handout and offer constructive feedback. Many of the illustrations were generously made available by the Biodiversity Heritage Library (\url{http://biodiversitylibrary.org}) and the photographers at Flickr (\url{http://flickr.com}).
